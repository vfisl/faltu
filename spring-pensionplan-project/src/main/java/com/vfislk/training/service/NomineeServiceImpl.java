...
public class NomineeServiceImpl implements INomineeService {
	...
	@Override
	public List<Nominee> getByCustomer(String firstName, String lastName) throws PlanNotFoundException {
		return nomineeRepository.findByCustomer(firstName, lastName);
	}
