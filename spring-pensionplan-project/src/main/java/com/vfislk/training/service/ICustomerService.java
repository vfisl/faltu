...
public interface ICustomerService {
	...
	List<Customer> getByAgent(String agentName) throws CustomerNotFoundExcepion;
	...
	List<Customer> getByNominee(String nomineeName) throws CustomerNotFoundExcepion;
