...
public class CustomerServiceImpl implements ICustomerService {
	...
	@Override
	public List<Customer> getByAgent(String agentName) throws CustomerNotFoundExcepion {
	...
	@Override
	public List<Customer> getByNominee(String nomineeName) throws CustomerNotFoundExcepion {
