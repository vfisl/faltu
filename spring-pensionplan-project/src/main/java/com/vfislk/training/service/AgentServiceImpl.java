...
public class AgentServiceImpl implements IAgentService {
	...
	@Override
	public List<Agent> getByCustomer(String firstName, String lastName) throws AgentNotFoundExcepion {
		return agentRepository.findAgentByCustomer(firstName, lastName);
	}
